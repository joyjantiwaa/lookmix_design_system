...
class SneakersBoldIcon extends StatelessWidget {
  final double size;
  final Color? color;

  const SneakersBoldIcon({
    super.key,
    this.size = 24,
    this.color,
  });
